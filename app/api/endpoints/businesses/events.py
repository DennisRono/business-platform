...
from business_platform.schemas.event import EventCreate, EventUpdate
...
async def update_event(
    ...
    return await EventController(db).update(business_id, event_id, payload.model_dump(exclude_none=True))